...
if __name__ == '__main__':
    ...
    #transformer_model=transformer_model.to(device='hip:1')
        ...
        if args.deepspeed_stage == 3:
            ds_config_state = {
                ...
                "zero_optimization": {
                    ...
                    "offload_param": {
                        "device": "cpu",
                        "pin_memory": False,    # True→Falseに変更してメモリ使用量を削減
                        "buffer_count": 2,
                        "buffer_size": 1e5,     # さらに小さくすることも検討
                        "max_in_cpu": 1e9       # CPU上の最大パラメータ数を制限
                    },
