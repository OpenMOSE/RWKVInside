...
def main():
    ...
    adapter_file = "/workspace/output/qwen3-8b/hxa079-stage2p2/pytorch_model.bin/pytorch_model.bin"  # Adapter の PyTorch モデルファイル
    output_file = "/workspace/output/qwen3-8b/hxa079-qwen3-8b-stage2-hybrid-final.pth"
