...
process_all_layers('/workspace/output/rekaflash3/PRWKV-7-rekaflash3-stage2p-v2-norm-scale.pth',"/workspace/output/rekaflash3/PRWKV-7-rekaflash3-stage2p-v2-norm-scale-ffnaligned.pth")
