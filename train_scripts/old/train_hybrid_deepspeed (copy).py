...
def create_arg_parser():
    ...
    parser.add_argument('--target_architecture', default='qwen',type=str,nargs='+',help='Target Architecture(qwen,llm-jp)')
    ...
    parser.add_argument('--save_per_batches', type=int, default=200, help='number of batches to save the model')
